...
const config = { // we use a nightwatch.conf.js file so we can include comments and helper functions
  "src_folders": [
    "test/e2e",
    "test/voofy"     // we use /test as the name of our test directory by default. so test/e2e for e2e
  ],
  "output_folder": "./node_modules/nightwatch/reports", // reports (test outcome) output by nightwatch
  "custom_commands_path": "./commons/commands",
  "custom_assertions_path": "./commons/assertions",
  // "globals_path": "./globals/example.js", //we don't need now.'
  "selenium": {
    "start_process": true,
